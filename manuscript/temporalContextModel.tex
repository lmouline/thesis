...
\begin{figure}
	\caption{Excerpt of the smart grid }
\end{figure}

Figure
The smart grid is composed of one data concentrator and three smart meters.
These meters regularly send consumption data at the same time.
...
$C_{SG} = \{M_1, M_2, M_3, D_1, V_1, V_2, V_3, V_4, V_5, V_6, V_7, V_8, V_9\}$\\
$A_{SG} = \{A_1, A_2\}$\\
$R_{SG} = \{R_1\}$
