...
%%% limitation Aintea
% all the different kinds of uncertainty
% all data structures
% all the different places where uncertainty is propagated


%%% limitation TKM
% we assumed that designers are able to link actions with their expected impacts at design time
% large model
