...
The literature provides different approaches to tackle challenges that come with the different aspect of uncertainty.
...
\paragraph{Sum up}
The widely approach to imperceptibly propagate uncertainty is to attach the propagation uncertainty to the language operators as we can see in \Cref{table:sota:results:duc:rq2.3.1}.
...
However, current solutions provide only what we call \textit{low level} techniques to reason over uncertainty (\cf \Cref{table:sota:results:duc:rq2.3.2}).
