...
\subsection{\langName{}: our implementation}
\label{sec:uminijava}
...
We also developed a simplified version of our use case example, introduced in Section~\ref{sec:lux-sg-scenario}\todo{update}.
