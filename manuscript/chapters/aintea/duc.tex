...
%% Ludo: I keep this comment for the major revision version :)
%\tha{Overall, I really like the chapter. Two main things remain to be improved in my opinion. First, it reads quite like a factual list of statements. I would weave some sentences like: 'this is why we decided to do this or this in our language like this or this Or: 'Even though we considered to do this and this in our language, we find that it is better/more convenient/has advantages to do it like this... '. Make the whole definitions more fluent and interesting to read, add some examples, etc. Make clear that it is YOUR language that you describe here rather than just explaining some aspects of probability theory.  Secondly, the presentation of lists, bullet points, subsections etc. is not very nice yet. I don't have concrete points yet but it looks visually not very nice. }
...
\begin{figure}
	\centering
	\includegraphics[width=0.9\linewidth]{img/sumup-contrib}
...
For example, values get from sensors are always given with a certain accuracy, \eg 18.4\textdegree C $\pm$ 0.1\textdegree C.
...
\begin{figure*}
    ...
    \subfloat[Gaussian and Rayleigh] {
        \includegraphics[width=.31\linewidth]{img/sec4/GaussRayleigh}
        \label{fig:gauss-ray}
    }
    \hfill
  \subfloat[binomial] {
        \includegraphics[width=.31\linewidth]{img/sec4/binomial}
        \label{fig:binom}
    }
    \hfill
    \subfloat[Dirac delta function] {
        \includegraphics[width=.31\linewidth]{img/sec4/dirac}
        \label{fig:dirac}
    }
    \hfill
...
The semantics of these operators are formalized in the next section.\looseness-1	
