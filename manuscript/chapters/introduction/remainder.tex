...
First, \Cref{chapt:example} described a motivating example, based on a \gls{sg} system.
Then, \Cref{chapt:background} describes the necessary background of the thesis.
