...
Among all the challenges described in the previous section, this thesis focus on three of them: \gls{duc} (\Cref{intro:challenges:u-data}), \glspl{longTermAct} (\Cref{intro:challenges:long-term-act}), and emergent behaviours (\Cref{intro:challenges:ermger-bhv}).
