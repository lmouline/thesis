...
\newglossaryentry{shealingSyst}
{
	...
	description={In this document, I use the definition provided by Kephart and Chess~\cite{DBLP:journals/computer/KephartC03}: \textquote{[A self-healing] system automatically detects, diagnoses, and repairs localized software and hardware problems.}}
}
