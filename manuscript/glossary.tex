...
\newglossaryentry{duc}
{
	...
	description={Data are uncertain when some data points are not precisely known.}
}
...
\newglossaryentry{sadapt}
{
	type=\acronymtype,
	name={SAS},
	description={Self-Adaptive System},
	first={Self-Adaptive System (SAS)\glsadd{sadaptg}},
	firstplural={Self-Adaptive Systems (SAS)},
	see=[Glossary:]{sadaptg}
}
