...
%
Parmi tous les défis décrits dans la section précédente, cette thèse se concentre sur trois d'entre eux : l'incertitude des données (\Cref{sec_french_challenges_longTermAct}), les actions à long terme (\Cref{sec_french_challenges_diagnosis}) et le processus d'adaptation sujet aux erreurs (\Cref{sec_french_challenges_diagnosis}). 
