...
Two research questions drove this review.
...
Additionally, it indicates that different solutions exist to model \gls{duc}, but some efforts need to be performed to provide solutions at a higher level.  
}

\input{parts/1-intro/sota/methodo}
\input{parts/1-intro/sota/result-tkm}
\input{parts/1-intro/sota/result-duc}
\input{parts/1-intro/sota/ttv}
\input{parts/1-intro/sota/conclusion}