...
\afterpage{
	...
	\begin{landscape}
		...
		\begin{tabular}{
    		...
    		\hline
    		\textbf{Approach} & \textbf{Reference} & \textbf{Cir\-cums\-tance} & \textbf{Ef\-fects?} & \textbf{Run\-time?} & \textbf{Ti\-me?}\\
    		\hline
    		Rule-based & \cite{DBLP:conf/icse/TaharaOH17, DBLP:conf/icse/ArcainiRS15, DBLP:conf/wrla/BruniCGLV12, DBLP:conf/eurosys/GraceHPBCT08, DBLP:conf/gpce/PintoFT03, DBLP:journals/computer/GarlanCHSS04} & Condition & Execu\-table code & \xmark & \xmark \\
    		Sate machine & \cite{DBLP:conf/icse/ArcainiRS15, DBLP:conf/icse/IftikharW14a, DBLP:conf/smartgridsec/0001FKNT14, DBLP:conf/sigsoft/MorenoCGS15, DBLP:conf/kbse/FilieriGLM11, DBLP:conf/wetice/DjoudiBZ14, DBLP:conf/aosd/ZhangGC09, DBLP:conf/icse/GhezziPST13, DBLP:conf/kbse/TajalliGEM10} & Guard and initial state of a tran\-si\-tion & End sate of a tran\-si\-tion & \cmark & \xmark\\
    		Publish / Sub\-scribe & \cite{DBLP:conf/icse/BarbosaLMJ17} & Condition & Execu\-table code & \xmark & \xmark\\
    		Goal-modelling & \cite{DBLP:conf/icse/MendoncaAR14, DBLP:conf/iceccs/BencomoWSW12, DBLP:conf/re/BaresiPS10} & Un\-sa\-tis\-fied goal & Ful\-fil\-ment of a goal & \xmark & \xmark \\
    		Program\-ming language & \cite{DBLP:journals/jss/ChengG12} & Condition & Language operator & \xmark & \cmark \\
    		Event-Condition Action & \cite{DBLP:conf/soco/DavidL06, DBLP:conf/icws/CharfiDM09, DBLP:journals/scp/ParraBCD11} & Condition & Action code & \xmark & \xmark \\
    		Model transformation & \cite{DBLP:conf/icse/ChenPYNZ14, DBLP:journals/tse/KramerM90} & Query & Trans\-for\-ma\-tion rule & \xmark & \xmark \\
    		Formal model & \cite{DBLP:journals/taas/WeynsHH10, DBLP:conf/icse/BartelsK11, DBLP:conf/aaai/CimattiMR15} & Condition & Code of the action & \xmark & \xmark \\ 
    		Dynamic Software Product-Lines & \cite{DBLP:conf/dagstuhl/GhezziS10, DBLP:series/lncs/CordyCHLS13} & Condition & Se\-lec\-ted con\-fi\-gu\-ra\-tion & \xmark & \xmark \\
    		Graph model & \cite{DBLP:journals/computer/GeorgasHT09} & Node & Node & \xmark & \xmark \\
    		\hline
    	\end{tabular}
...
\paragraph{Approaches based on aPublish/Subscribe mechanism}
...
\paragraph{Approaches based on model transformations}
...
\paragraph{Approaches based on a graph model}
...
\paragraph{Approach based on aspect-oriented programming}
