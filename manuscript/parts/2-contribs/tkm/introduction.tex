...
To address Sub-challenge \#2 and Sub-challenge \#3 (\cf \Cref{sec:intro:scope}), we propose a temporal knowledge \gls{model} which can trace decisions over time, along with their circumstances and effects.
