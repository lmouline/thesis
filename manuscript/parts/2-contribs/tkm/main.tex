...
We also demonstrate its scalability both in terms of execution time and consumed memory.
 ...
 \input{parts/2-contribs/tkm/introduction}
 \input{parts/2-contribs/tkm/formalism}
 \input{parts/2-contribs/tkm/mm}
 \input{parts/2-contribs/tkm/validation}
 \input{parts/2-contribs/tkm/conslusion}
